...
if (isset($_POST['college'])) {
    ...
    $sectionQuery = "
                ...
                SELECT id,COALESCE(name,'') as name,COALESCE(address,'') as address,COALESCE(phonenumber,'') as phonenumber,COALESCE(gender,'') as gender,COALESCE(email,'') as email,COALESCE(course,'') as course,COALESCE(department,'') as department, approved, accounttype, COALESCE(college,'') as college,
                COALESCE(company_name,'') as company_name   FROM user WHERE 1=1 ";
